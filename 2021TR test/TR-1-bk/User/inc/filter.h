...
#define SAMP_TIME 0.0001005 /*采样周期(s)*/   //4*115200/(10*8)?
//#define SCALE 0.0127       /*(1000*5)/(65535*6)*(N-ZERO_POinT)*/ 两个代码中scale都没有用到过
#define MAX_NUM 5 /*冒泡排序处理数据的数目*/
#define MAX_ZP_SAMPLE 2000
#define ZERO_THREDHOLD  (float)(44.788452) /*如果前后两次采样的绝对值小于阈值，则用此数据更新零点*/  //(2.5-(-2.5))*2500/8388608/(350/0.01)  emmm 2^23/(350*0.01)
